...
import os
import json
from connection import save_msg
...
result = channel.queue_declare(queue="db_messages", exclusive=True, durable=True)
queue_name = result.method.queue

#La cola se asigna a un 'exchange'
channel.queue_bind(exchange='nestor', queue=queue_name, routing_key="db_messages")
